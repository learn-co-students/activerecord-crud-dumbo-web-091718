...
def can_be_found_updated_and_saved()
  ...
  find_n_update = Movie.find_by(title: "Awesome Flick")
  find_n_update.update(title: "Even Awesomer Flick")
  find_n_update.save
...
def can_update_using_update_method
  ...
  m =  Movie.create(title: "Wat?")
   ...
   find_n_update = Movie.find_by(title: "Wat?")
   find_n_update.update(title: "Wat, huh?")
   # find_n_update.save
...
def can_destroy_a_single_item
  ...
  must_go = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  must_go.destroy
end
